...
class UInputAction;
class IDzX_RadialMenu_Interface;
UENUM(BlueprintType)
...
private:
	...
	UPROPERTY()
	int32 CurrentSegmentID = -1;

public:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Input")
	const UInputAction* InputActionClick = nullptr;
	/*Is this menu active.
	...
	//SegmentAngle to rotate slot 0 in menu. By default its on 12h position.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Parameters")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Parameters")
	bool bIsGamepadControlled = false;
